...
public class MemberFieldInitializationMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("1-2. 인스턴스 멤버필드는 선언시 초기값으로 초기화 할 수 있다.");
		...
		DuoMember paramMember=new DuoMember(1, "일번남");
		MemberField mf2=new MemberField(333, 3.2, '가', true, "박주용", null);
