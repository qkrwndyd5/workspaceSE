...
public class ReferenceVariableMain {
	...
	public static void main(String[] args) {
		...
		DuoMember memberOne = new DuoMember(1,"일번지");
		DuoMember memberTwo = new DuoMember(2,"이번지");
		...
		DuoMember m1=new DuoMember(1000,"김나박");
		DuoMember m2=new DuoMember(2000,"김호박");
		m1.print();
		m2.print();
		...
		System.out.println("----참조변수 초기화 기본값-----");
		DuoMember m3=null;
		/*
		 * null: 객체주소 리터럴값
		 * 	- 객체주소값 초기화의 용도로 사용
		 * 	- null주소 사용시 nullPointerException 이 발생
		 */
		if(m3==null) {
			m3=new DuoMember(3,"용용이");
			m3.print();
		}else {
			m3.print();
		}
