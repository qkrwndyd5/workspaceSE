...
public class OperactorLogical {
	...
	public static void main(String[] args) {
		...
		System.out.println("-- A대학 국어점수가 90점이상이거나 영어점수가 90점이상이라면 합격");
		boolean isPass1 = condition3 || condition1;
