...
public class CarMemberFieldMain {
	...
	public static void main(String[] args) {
		 ...
		 * 1. 차량번호 1234차량 12시입차
		 */
		Car car1; 			// 차객체의 주소값을 지정할Car타입 참조(주소)변수 선언
		car1 = new Car(); 	// Car클래스를 사용해서 차객체를 힙메모리에 생성후 
		                  	// 차객체의 주소값이 car1참조(주소)변수에 대입
		
		car1.no="1234"; // 차객체(car1)의 멤버필드 no에		"1234"값대입
		car1.inTime=12;	// 차객체(car1)의 멤버필드 inTime에  12 값대입
		/*
		 * 2. car1차량 16시 출차
		 */
		/*
		 * 2-1. 출차시간대입
		 */
		car1.outTime=16; // 차객체(car1)의 멤버필드 outTime에 16 값대입
