...
public class ProPertiesFileLoadMain {
	...
	public static void main(String[] args) throws Exception{
		...
		/*
		 	*.properties파일은 loading해서 Properties객체[Map]를 만들어준다.
		 */
		
		Properties properties = new Properties();
		/*
		FileInputStream fis1 = new FileInputStream("C:\\2022-11-java-developer\\workspaceSE\\25_JDBC[Java DataBase Connectivity]\\src\\jdbc properties");
