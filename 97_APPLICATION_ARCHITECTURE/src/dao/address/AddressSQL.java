...
public class AddressSQL {
	...
	public static final String ADDRESS_SELETE_BY_NO = "select no,name,phone,address from address where no=?";
	public static final String ADDRESS_SELETE_ALL = "select no,name,phone,address from address";
}
