...
public class StudentMemberFieldMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.printf("-----------------------------------------------%n");
		System.out.printf("%3d %4s %4d %4d %4d %4d %4.1f %3c %4d%n",st1.num,st1.name, st1.kor,st1.eng,st1.math,st1.total,st1.avg,st1.grade,st1.rank );
		System.out.printf("%3d %4s %4d %4d %4d %4d %4.1f %3c %4d%n",st2.num,st2.name, st2.kor,st2.eng,st2.math,st2.total,st2.avg,st2.grade,st2.rank );
		System.out.printf("-----------------------------------------------%n");
