...
public class DateCalendarMain {
	...
	public static void main(String[] args) throws Exception{
		...
		System.out.println(myBirthDay.getDate());
		System.out.println(myBirthDay.getDay());
		System.out.println(myBirthDay.getHours());
		System.out.println(myBirthDay.getMinutes());
		*/
		
		sdf2.applyPattern("yyyy/MM/dd HH:mm:ss");
		Date yourBirthDay=sdf2.parse("1996/07/24 17:45:32");
		...
		long currentTimeMillis = cal1.getTimeInMillis();
		System.out.println("cal1.getTimeInMillis()-->"+currentTimeMillis);
		...
		System.out.println("getMilliSec:"+gapMilliSec);
