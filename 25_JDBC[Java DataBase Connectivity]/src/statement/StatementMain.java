...
public class StatementMain {
	...
	public static void main(String[] args) throws Exception{
		...
		String insertSql="insert into emp values(9000, 'KIM', 'MANAGER', null, to_date('2000/03/03','YYYY/MM/DD'), 80000, null, 20)";
		...
		DEPTNO            NUMBER(2)    
		 */
		System.out.println("---------stmt.executeQuery(deleteSql);----------");		
