...
public class FileMain {
	...
	public static void main(String[] args) throws Exception{
		/*
		 * 현재파일경로[기준경로]
		 *    eclipse --> C:\2022-11-java-developer\workspaceSE\20_입출력[IO]
		 *    
		 * 상대경로(relative)경로
		 *    현재경로를 기준으로 경로를기술
		 *    simple\a.txt
		...
		File file2=new File("sample\\02인코딩테이블.png");
		File file3=new File("sample/subsample/HTML.txt");
		File file4=new File("C:\\2022-11-java-developer\\workspaceSE\\20_입출력[IO]\\sample");
		...
		System.out.println("----------6.디렉토리안에 파일(디렐토리)목록(String[])-----------");
		String[] fileNameList=dir1.list();
		for (String fileName : fileNameList) {
			System.out.println(fileName);
		}
		System.out.println("----------7.디렉토리안에 파일(디렐토리)목록(File[])-----------");
		...
		File newDir3=new File("sample","subsample");
