	...
	public class ChatServerThread extends Thread {
		...
		public void run() {
			...
			while(true) {
				...
				setLog("3.ChatServerThread:ClientService 객체에 ServerClientThread에 추가 쓰레드 start");	
		...
		public void run() {
			try {
				...
				while(true) {
					...
					//System.out.println("다.ServerClientThread:연결된모든 클라이언트에 읽은데이타 전송");
