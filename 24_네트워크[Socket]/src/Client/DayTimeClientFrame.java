...
public class DayTimeClientFrame extends JFrame {
	...
	private JButton RequestServerButton;
	...
	public DayTimeClientFrame() {
		...
		JLabel timeDispayLabel = new JLabel("12:00");
		timeDispayLabel.setForeground(new Color(0, 128, 255));
		timeDispayLabel.setHorizontalAlignment(SwingConstants.CENTER);
		timeDispayLabel.setFont(new Font("굴림", Font.PLAIN, 24));
		contentPane.add(timeDispayLabel, BorderLayout.CENTER);
	
		RequestServerButton = new JButton("RequestServerTime");
		RequestServerButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					 ...
					 * 1. Socket 생성
					 */
					Socket socket = new Socket("192.168.15.4", 8000);
					/*
		...
		contentPane.add(RequestServerButton, BorderLayout.SOUTH);
